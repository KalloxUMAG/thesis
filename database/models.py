...
class Antibody(Base):
    ...
    antigens = relationship("Antigen", secondary="interaction", back_populates="antibodies")
    databases = relationship("Database", secondary="antibody_has_database", back_populates="antibodies")
    aa_interactions = relationship("Aa_interaction", secondary="antibody_has_aa_interaction", back_populates="antibodies")
...
class Antigen(Base):
    ...
    antibodies = relationship("Antibody", secondary="interaction", back_populates="antigens")
    databases = relationship("Database", secondary="antigen_has_database", back_populates="antigens")
    epitopes = relationship("Epitope", secondary="antigen_has_epitope", back_populates="antigens")
    gene_ontologys = relationship("Gene_ontology", secondary="antigen_has_go", back_populates="antigens")
    pfams = relationship("Pfam", secondary="antigen_has_pfam", back_populates="antigens")
...
class Gene_ontology(Base):
    ...
    antigens = relationship("Antigen", secondary="antigen_has_go", back_populates="gene_ontologys")
    #Descomentar para relacion de Antibody_Chain con Pfam y GO
    #antibody_chains = relationship("Antibody_chain", secondary="antibody_chain_has_go", back_populates="gene_ontologys")
...
class Pfam(Base):
    ...
    antigens = relationship("Antigen", secondary="antigen_has_pfam", back_populates="pfams")
    #Descomentar para relacion de Antibody_Chain con Pfam y GO
    #antibody_chains = relationship("Antibody_chain", secondary="antibody_chain_has_pfam", back_populates="pfams")
...
class Antibody_chain(Base):
    ...
    #gene_ontologys = relationship("Gene_ontology", secondary="antibody_chain_has_go", back_populates="antibody_chains")
    #pfams = relationship("Pfam", secondary="antibody_chain_has_pfam", back_populates="antibody_chains")
...
class Epitope(Base):
    ...
    epitope_type_id = Column(Integer, ForeignKey("epitope_type.id", ondelete="SET NULL"))
    databases = relationship("Database", secondary="epitope_has_database", back_populates="epitopes")
    antigens = relationship("Antigen", secondary="antigen_has_epitope", back_populates="epitopes")
...
class Antibody_has_aa_interaction(Base):
    ...
    antibody_id = Column(Integer, ForeignKey("antibody.id"), primary_key=True)
    aa_interaction_id = Column(Integer, ForeignKey("aa_interaction.id"), primary_key=True)

#Descomentar para relacion de Antibody_Chain con Pfam y GO
'''
class Antibody_chain_has_go(Base):
    __tablename__ = 'antibody_chain_has_go'

    antibody_chain_id = Column(Integer, ForeignKey("antibody_chain.id"), primary_key=True)
    go_id = Column(Integer, ForeignKey("gene_ontology.id"), primary_key=True)
    probability = Column(Integer)

class Antibody_chain_has_pfam(Base):
    __tablename__ = 'antibody_chain_has_pfam'
